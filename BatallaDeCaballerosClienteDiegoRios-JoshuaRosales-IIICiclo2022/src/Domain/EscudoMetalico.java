 ...
 * @author Diego
 */
//Se crea la clase EscudoMetalico que hereda de la clase abstracta CartaDefensa
public class EscudoMetalico extends CartaDefensa {

    public EscudoMetalico(double posX, double posY) throws IOException {
        super(posX, posY);
        this.poderAtaque = 0;
        this.poderDefensa = 15;
        this.imagen = ImageIO.read(getClass().getResourceAsStream("/Imagenes/escudoMetallicoCarta.png"));
        this.numCarta = 5; //Identificador
    }//constructor
    ...
    @Override
    //Se hereda el metodo de CartaDefensa en el cual se realiza el comportamiento de la carta EscudoMetalico
