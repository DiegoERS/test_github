 ...
 * @author Diego
 */
//Se crea la clase EscudoMadera que hereda de la clase abstracta CartaDefensa
public class EscudoMadera extends CartaDefensa{

    public EscudoMadera(double posX, double posY) throws IOException {
        super( posX, posY);
          this.poderAtaque=0;
        this.poderDefensa=10;
        this.imagen = ImageIO.read(getClass().getResourceAsStream("/Imagenes/escudoMaderaCarta.png"));
        this.numCarta = 4; //Identificador
    }//constructor
    ...
    @Override
    //Se hereda el metodo de CartaDefensa en el cual se realiza el comportamiento de la carta EscudoMadera
