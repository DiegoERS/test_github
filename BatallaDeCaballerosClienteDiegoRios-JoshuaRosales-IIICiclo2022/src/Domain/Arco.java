 ...
 * @author Diego
 */
//Se crea la clase Arco que hereda de la clase abstracta CartaAtaque
public class Arco extends CartaAtaque {

    public Arco(double posX, double posY) throws IOException {
        super( posX, posY);
        this.poderAtaque=8;
        this.poderDefensa=0;
        this.imagen = ImageIO.read(getClass().getResourceAsStream("/Imagenes/arcoCarta.png"));
        this.numCarta = 2; //Identificador
    ...
    @Override
     //Se hereda el metodo de accionCarta en el cual se realiza el comportamiento de la carta arco
